 ...
 */
;(function (angular) {
System.register(['UrlConstructionService'], function (_export) {
    'use strict';

    var UrlConstructionService;
    return {
        setters: [function (_UrlConstructionService2) {
            UrlConstructionService = _UrlConstructionService2['default'];
        }],
        execute: function () {
